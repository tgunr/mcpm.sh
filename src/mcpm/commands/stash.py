...
def stash(server_name):
    ...
    if client_config_manager.is_server_stashed(client, server_name):
    ...
    stash_success = client_config_manager.stash_server(client, server_name, server_data)
    ...
    if stash_success:
        ...
        if remove_success:
            ...
            client_config_manager.pop_server(client, server_name)
